defmodule JustTravel.Ticket.Cart.Command.GetCartByIdTest do
  ...
  describe "changeset/2" do
    test "returns a valid changeset", %{params: params} do
      assert %Ecto.Changeset{valid?: true} = Cart.Command.GetCartById.changeset(params)
    end
    ...
    test "returns error on invalid input" do
      assert %Ecto.Changeset{
             ...
             } = Cart.Command.GetCartById.changeset(%{cart_id: 123})
    end
    ...
    test "returns error on missing required params" do
      assert %Ecto.Changeset{
             ...
             } = Cart.Command.GetCartById.changeset(%{id: 123})
    end
  end
end
