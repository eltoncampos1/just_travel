defmodule JustTravelWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(JustTravelWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(JustTravelWeb.Gettext, "errors", msg, opts)
    end
  end
